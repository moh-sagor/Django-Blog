...
import uuid
from App_Blog.forms import CommentForms
...
class BlogList(ListView):
    ...
    # queryset = Blog.objects.order_by('-publish_date')  [do same from models.py]
...
class UpdateBlog(LoginRequiredMixin, UpdateView):
    ...
    def get_success_url(self, **kwargs):
        return reverse_lazy('App_Blog:blog_details', kwarg ={'slug':self.object.slug})
